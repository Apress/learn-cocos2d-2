...
// In Kobold2D the hit test code is handled by the KKHitTest class which implements the
// commented out code shown below. The config.lua parameter EnableGLViewNodeHitTesting
// is used to enable/disable the hit testing code (disabled by default, enabled for this project).
/*
